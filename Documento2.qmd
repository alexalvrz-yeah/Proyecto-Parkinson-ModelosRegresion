...
nuestro criterio para binarizar será uno simple: 50% más bajos (0) y 50%
más altos (1).
...
Veamos, por último, el área debajo de la curva (AOC):
...
Y, si los hubíesemos visto, habríamos usado un modelo mixto (que habría
dado un mejor resultado).
