...
Bueno, no soy yo quién para juzgar pero buena pinta no tiene, vamos a empezar con la selección de variables, usando el cirterio de informacion de Akaike (AIC)
...
modelo_gamma <- glm(motor_UPDRS ~ age + sex + jitter_abs + jitter_ppq5 + 
