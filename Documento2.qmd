...
resultados_step <- data.frame(real = test$total_UPDRS, pred = pred_step)
...
resultados_step <- data.frame(real = test$motor_UPDRS, pred = pred_step)
...
# Usamos train y le metemos curvas (s) a todas las continuas
...
predicciones <- predict(modelo_gamma_final, newdata = test, type = "response")

# 3. CÁLCULO DE MÉTRICAS
resultados <- data.frame(
  real = test$total_UPDRS,  # Asegúrate de que esta es la variable que predices
