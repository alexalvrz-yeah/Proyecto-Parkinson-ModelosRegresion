...
pero el RMSE es mejor. Eso sí, puede que con tanto lío de tipos
distintos de particiones el RMSE haya terminado perdiendo significado.
...
de regresión lineal simple, modelos no lineales y transformación de
variables, modelo gamma, sección en la que se aplica la PCA, y mucha
ayuda en la teoría aplicada del trabajo.
