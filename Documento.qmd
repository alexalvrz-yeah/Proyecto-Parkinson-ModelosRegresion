...
# info mutua
v_mutinfo <- c(mut_info_discrete(x = train$jitter_pct, y = train$motor_UPDRS),
             mut_info_discrete(x = train$jitter_abs, y = train$motor_UPDRS),
             mut_info_discrete(x = train$jitter_rap, y = train$motor_UPDRS),
             mut_info_discrete(x = train$jitter_ppq5, y = train$motor_UPDRS),
             mut_info_discrete(x = train$jitter_ddp, y = train$motor_UPDRS),
             mut_info_discrete(x = train$shimmer, y = train$motor_UPDRS),
             mut_info_discrete(x = train$shimmer_db, y = train$motor_UPDRS),
             mut_info_discrete(x = train$shimmer_apq3, y = train$motor_UPDRS),
             mut_info_discrete(x = train$shimmer_apq5, y = train$motor_UPDRS),
             mut_info_discrete(x = train$shimmer_apq11, y = train$motor_UPDRS),
             mut_info_discrete(x = train$shimmer_dda, y = train$motor_UPDRS),
             mut_info_discrete(x = train$nhr, y = train$motor_UPDRS),
             mut_info_discrete(x = train$hnr, y = train$motor_UPDRS),
             mut_info_discrete(x = train$rpde, y = train$motor_UPDRS),
             mut_info_discrete(x = train$dfa, y = train$motor_UPDRS),
             mut_info_discrete(x = train$ppe, y = train$motor_UPDRS)
             )
# dataframe para imprimirlo como tabla
data.frame(v_pearson, v_spearman, v_mutinfo, row.names = c("jitter_pct", "jitter_abs", "jitter_rap", "jitter_ppq5", "jitter_ddp", "shimmer", "shimmer_db", "shimmer_apq3", "shimmer_apq5", "shimmer_apq11", "shimmer_dda", "nhr", "hnr", "rpde", "dfa", "ppe"))

```

Parece que las tres métricas de la tabla coinciden: una sola variable no
es suficiente para poder predecir.
