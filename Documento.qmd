...
embargo, el test de Shapiro-Wilk indica que la distribución no es
normal, al ser el p-valor menor a 0.05.
...
La distribución de la segunda variable tiene la forma de una normal con
una gran cola izquierda, y la de la primera sigue una distribución que a
